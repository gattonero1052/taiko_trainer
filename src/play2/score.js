...
import {STATIC_TEXT_STYLE} from "./constants";
...
const draw = function(game){
    let g = game.progressBar.graphics
    let percentage = 80
    let left = game.dimensions.SCORE_BOARD_LEFT,
        right = game.dimensions.SCORE_BOARD_RIGHT
...
class ProgressBarComponent extends Component{
    ...
    drawBg(g){
        ...
        let left = this.context.dimensions.SCORE_BOARD_LEFT,
         right = this.context.dimensions.SCORE_BOARD_RIGHT
        left.w = right.x - left.x
        right.h = left.h+left.y-right.y
    ...
    render() {
        return (<>
                <Text text={"123"} {...this.context.dimensions.SCORE_NUMBER} style={STATIC_TEXT_STYLE.score}></Text>
